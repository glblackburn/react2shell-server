...
| [BUG-7](BUG-7.md) | Open | High | High | Scanner Connection Timeout After Version Switch in Next.js Mode | After version switch, scanner times out with "Read timed out" errors. Server appears ready to script but scanner cannot connect within 10-second timeout |
